 ...
 */
final class Version20240929015257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, biography TEXT DEFAULT NULL, profile_picture VARCHAR(255) DEFAULT NULL, profile_picture_updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN author.profile_picture_updated_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, number_of_pages INT DEFAULT NULL, available_quantity INT DEFAULT NULL, language VARCHAR(255) DEFAULT NULL, publisher VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
